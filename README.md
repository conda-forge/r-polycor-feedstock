...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=6126&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/r-polycor-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `r-polycor` can be installed with `conda`:
...
```
mamba install r-polycor
```

It is possible to list all of the versions of `r-polycor` available on your platform with `conda`:
...
```
mamba search r-polycor --channel conda-forge
```
...
mamba repoquery search r-polycor --channel conda-forge

# List packages depending on `r-polycor`:
mamba repoquery whoneeds r-polycor --channel conda-forge

# List dependencies of `r-polycor`:
mamba repoquery depends r-polycor --channel conda-forge
```
